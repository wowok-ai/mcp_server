...
export const CallPermissionDataSchema = z.object({
    ...
    biz_permission: z.union([
        ...
        z.object({
            op: z.literal('remove'),
            permissions: z.array(z.number().int().min(WOWOK.PermissionIndex.user_defined_start).describe('User-defined permission number'))
...
export const CallRepositoryDataSchema = z.object({
    ...
    policy: z.union([
        ...
        z.object({
            op: z.literal('remove'),
            keys: z.array(z.string().nonempty().describe('Key filed of a Policy.'))
