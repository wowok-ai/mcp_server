...
export const AccountOperationSchema = z.object({
    ...
    default: z.object({
            name_or_address: z.string().nonempty().describe("The name or address of the account to set as default."),
    ...
    suspend: z.object({
        ...
        }).optional().describe("Suspend the account."),
    name: z.object({
...
}).describe('Account operation, such as generate a new account or transfer tokens from one account to another.The operations are performed one after the other in the field order.');
...
}).describe('Local mark operation, such as add or set local marks, remove local marks or remove all local marks.The operations are performed one after the other in the field order.');
...
}).describe('Local info operation, such as add local info or remove local info.The operations are performed one after the other in the field order.');
